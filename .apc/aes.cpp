...
/*
static const byte sbox[256] = SBOX_DATA;
#define SBOX_ACCESS(i,j) sbox[j]
*/

static const byte sboxes[20][256] = {SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,
SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA,
SBOX_DATA,SBOX_DATA,SBOX_DATA,SBOX_DATA
};
#define SBOX_ACCESS(i,j) sboxes[i][j]

#define INST_RCON(name) static const byte name [] = { \
0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab \
};

static byte state[16];
static byte statekey[16];
...
for(i = 0; i < 16; i++)
{
state[i] = SBOX_ACCESS(i, state[i]);
}
}

/* Shift Rows just swaps around rows
*/
void shiftRows(void)
{
byte temp;
...
buf0 =  SBOX_ACCESS(16, statekey[13]);
buf1 =  SBOX_ACCESS(17, statekey[14]);
buf2 =  SBOX_ACCESS(18, statekey[15]);
buf3 =  SBOX_ACCESS(19, statekey[12]);
...
#pragma HLS ARRAY_PARTITION variable=statekey complete dim=1
#pragma HLS PIPELINE
