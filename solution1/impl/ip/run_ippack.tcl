...
set IPName      "aestest"
set Version     "1.0"
set DisplayName "Aestest"
set Revision    "1504171424"
...
set Interfaces {
    S_AXI_AES_IO {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_aes_io"
        param_prefix "C_S_AXI_AES_IO"
        addr_bits "7"
    }
    interrupt {
        type "interrupt"
        ...
        axi4 {
            ...
            set rtl_ports [list \
                ...
                [list AWUSER  $dir0 1  "${param_prefix}_AWUSER_WIDTH" \
                    ...
                    enablement_dependency "(spirit:decode(id('PARAM_VALUE.${param_prefix}_ENABLE_USER_PORTS')))" \
                ] \
                [list AWVALID $dir0 "" ""] \
                [list AWREADY $dir1 "" ""] \
